        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children:[
                Text('Welcome to Jero Pay',style: kEncodeSansSemiBold.copyWith(color: purple,fontSize: sizeHorizontal*2.5),),
            SizedBox(height: sizeVertical*2,),
            Text('Jero Pay is a registered telecommunication company that offers instant Data top-up,Airtime Recharge,Cable TV subscription (DSTV,GOtv,StarTimes),Electricity Bill Payment,Airtime to Cash Bulk SMS,Data Card Pin generation and more. \n we have one of the best telecommunication platforms in Nigeria with a detailed API documentation, swift multi-wallet funding channels and a robust customer service unit.'),
            SizedBox(height: sizeVertical*3,),
            Text('We are automated:',style: kEncodeSansSemiBold.copyWith(color: purple,fontSize: sizeHorizontal*2.5),),
            SizedBox(height: sizeVertical*2,),
            ...
            SizedBox(height: sizeVertical*3,),
            Text('we are reliable:',style: kEncodeSansSemiBold.copyWith(color: purple,fontSize: sizeHorizontal*2.5),),
            SizedBox(height: sizeVertical*2,),
            ...
            SizedBox(height: sizeVertical*3,),
            Text('we are safe and secure:',style: kEncodeSansSemiBold.copyWith(color: purple,fontSize: sizeHorizontal*2.5),),
            SizedBox(height: sizeVertical*2,),
            ...
            SizedBox(height: sizeVertical*3,),
            Text('we are always here',style: kEncodeSansSemiBold.copyWith(color: purple,fontSize: sizeHorizontal*2.5),),
            SizedBox(height: sizeVertical*2,),
