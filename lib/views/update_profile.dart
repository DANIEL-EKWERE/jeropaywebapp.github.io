...
class _UpdateUserProfileState extends State<UpdateUserProfile> {
  ...
  void udateProfile() async {
    final location = await DataBaseProvider().getLocation();
    final state = await DataBaseProvider().getState();
    final phone = await DataBaseProvider().getPhone();
    final recommendedBy = await DataBaseProvider().getRecommendedBy();

    setState(() {
      selectedValue = location;
      textController1.text = phone;
      selectedValue2 = state;
      textController1.text = recommendedBy;
      textController3.text = phone;
    });
  }
